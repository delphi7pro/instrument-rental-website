          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label className="text-sm font-medium">Подытог</Label>
                    <p className="text-lg font-bold mt-1">₽{order.subtotal.toLocaleString()}</p>
                  </div>
                  <div>
                    <Label className="text-sm font-medium">НДС</Label>
                    <p className="text-lg font-bold mt-1">₽{order.tax.toLocaleString()}</p>
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <p className="mt-1">{order.deliveryInfo.address}</p>
                  {order.deliveryInfo.timeSlot && (
                    <p className="text-sm text-gray-600">Время: {order.deliveryInfo.timeSlot}</p>
                  )}
                </div>
